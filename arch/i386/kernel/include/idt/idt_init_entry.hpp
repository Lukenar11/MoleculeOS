...
namespace kernel::idt 
{
    ...
    inline constexpr IDT_INIT_Entry idt_init_table[] = {
        { 0, isr::isr_0 }, { 1, isr::isr_1 }, { 2, isr::isr_2 }, { 3, isr::isr_3 }, 
        { 4, isr::isr_4 }, { 5, isr::isr_5 }, { 6, isr::isr_6 }, { 7, isr::isr_7 }, 
        { 8, isr::isr_8 }, { 9, isr::isr_9 }, {10, isr::isr_10}, {11, isr::isr_11}, 
        {12, isr::isr_12}, {13, isr::isr_13}, {14, isr::isr_14}, {15, isr::isr_15}, 
        {16, isr::isr_16}, {17, isr::isr_17}, {18, isr::isr_18}, {19, isr::isr_19}, 
        ...
        {44, irq::irq_12}, {45, irq::irq_13}, {46, irq::irq_14}, {47, irq::irq_15}
    };
} // namespace kernel::idt 
