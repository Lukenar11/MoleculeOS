...
namespace shell::commands
{
    void help() noexcept {
        static const char help_message[] = {
            ...
            "\t\t(write [Message] to [File]) echo [Message] > [File].[FileFormat] /\n"
            "\t\t(write the content of [File] to the console) echo < [File] /\n"
            "\t\t(write the content of [File] to the console) echo < [File].[FileFormat]\n"
            "\t- create (creates a file) |\n"
            "\t\tcreate [FileName] /\n"
            "\t\tcreate [FileName] [FileByteSize] /\n"
            "\t\tcreate [FileName].[FileFormat] / \n"
            "\t\tcreate [FileName].[FileFormat] [FileByteSize]\n"
