...
void test_create_file()
{
    ...
    void* a = kernel::filesystem::MoleculeOS_File_System::create_file("hello_world", "txt");
    void* b = kernel::filesystem::MoleculeOS_File_System::create_file("test", "");

    void* c = kernel::filesystem::MoleculeOS_File_System::get_inode_by_name_and_format("hello_world", "txt");
    void* d = kernel::filesystem::MoleculeOS_File_System::get_inode_by_name_and_format("test", "");
...
void test_write_file_read_file_string()
{
    ...
    kernel::filesystem::Inode* x = kernel::filesystem::MoleculeOS_File_System::create_file("string_test", "txt");

    const char* data = "abcdeABCDE";
    const uint32_t n = 10;

    if (kernel::filesystem::MoleculeOS_File_System::set_file_content_as_string(x, data, n))
    ...
    if (kernel::filesystem::MoleculeOS_File_System::get_file_content_as_string(x, buffer, 11))
...
void test_write_file_read_file_binary()
{
    ...
    kernel::filesystem::Inode* x = kernel::filesystem::MoleculeOS_File_System::create_file("bin_test", "bin");

    uint8_t data[10] = { 1, 2, 3, 4, 5, 100, 101, 102, 103, 104 };
    const uint32_t n = 10;

    if (kernel::filesystem::MoleculeOS_File_System::set_file_content_binary(x, data, n))
    ...
    if (kernel::filesystem::MoleculeOS_File_System::get_file_content_binary(x, buffer, 10))
